...
the signal is periodic. With only L = 17 sublayers, the first and
last few values of phi and omega can be biased. We report mean |z|
and mean omega over an "interior" window (excludes first / last 2
samples) alongside the global statistics.
